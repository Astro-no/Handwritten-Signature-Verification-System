...
$sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,AvailableCopies=:copies where id=:bookid";
...
<head>
    ...
    <title>MERU UNIVERSITY OF SCIENCE AND TECHNOLOGY | Edit Book</title>
...
<p class="help-block">An ISBN is an International Standard Book Number.ISBN Must be unique</p>
 ...
 <div class="form-group">
 <label>Availble Copies<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="copies" value="<?php echo htmlentities($result->AvailableCopies);?>"   required="required" />
 </div>
 <?php }} ?>
