...
<head>
    ...
    <title>MERU UNIVERSITY OF SCIENCE AND TECHNOLOGY | Password Recovery </title>
...
<input class="form-control" type="password" name="newpassword" required autocomplete="off" title="Password must be at least 8 characters and contain letters and numbers."  required pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@#$%^&+=!_])[A-Za-z\d@#$%^&+=!_]{8,}$"/>
</div>
